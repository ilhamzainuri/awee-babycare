      ...
      <aside className="hidden md:flex flex-col w-72 bg-surface-container-lowest border-r border-surface-container-high transition-all">
        <div className="p-8 border-b border-surface-container">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-bold text-on-surface text-sm">Clinic Director</h2>
              <p className="text-xs text-on-surface-variant">Medical Center Alpha</p>
            </div>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-40 bg-surface-container-lowest/80 backdrop-blur-md border-b border-surface-container h-16 flex items-center justify-between px-4 md:px-8">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-bold text-primary-container tracking-tight">Pediatric Admin</h1>
          </div>
          ...
          <>
            ...
            >
              <div className="px-8 mb-8">
                 <h1 className="text-2xl font-bold text-primary-container mb-6">Pediatric Admin</h1>
